      ...
      <Navbar>
        ...
        <NavBody>
          ...
          >
            ...
            <Link href="https://space.bilibili.com/yourid" target="_blank" rel="noopener noreferrer">
        ...
        <MobileNav>
          ...
          <MobileNavMenu isOpen={isMobileMenuOpen} onClose={() => setIsMobileMenuOpen(false)}>
            ...
            <div className="flex w-full flex-col gap-4 mt-4">
              <Link href="https://github.com/yourusername" target="_blank" rel="noopener noreferrer" className="w-full">
                <NavbarButton
                  onClick={() => setIsMobileMenuOpen(false)}
                  variant="secondary"
